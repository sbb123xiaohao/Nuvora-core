...
static const struct command_help commands[] = {
    ...
    {"step", "step PATH", "Change the current directory.", "step /home", "Paths accept /, . and .. ."},
    {"glance", "glance [PATH]", "List directory entries and file sizes.", "glance /apps",
     "The default path is the current directory."},
    {"nest", "nest PATH", "Create a directory.", "nest /home/notes", "The parent must already exist."},
    {"weave", "weave FILE TEXT", "Create or replace a text file with one line.",
     "weave /home/note.txt \"Hello Nuvora\"", "Replaces existing contents. Use anchor to save /home to disk."},
    {"stitch", "stitch FILE TEXT", "Append a line to a text file.",
     "stitch /home/note.txt \"Second line\"", "Creates the file if needed. Use anchor to save /home to disk."},
    ...
    {"folio", "folio [FILE]", "Open the full-screen text and formatted-document editor.",
     "folio /home/report.nvd", "Ctrl-S saves, Ctrl-Q closes, F1 shows shortcuts.\n"
    ...
    {"forge", "forge APP [ARGUMENTS]", "Run a program and wait for its exit status.",
     "forge pulse --help", "Names without / are resolved under /apps. Arguments are joined with spaces."},
    ...
    {"gather", "gather PID", "Wait for one child process and show its exit status.",
     "gather 2", "The PID must identify an unwaited child of this shell."},
    {"quench", "quench PID", "Terminate a process by PID.", "quench 2", "PID 1 cannot be terminated."},
    {"tempo", "tempo", "Show monotonic timer ticks since boot.", "tempo", "There are 100 ticks per second."},
